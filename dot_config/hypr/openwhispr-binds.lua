...
-- If you delete this file, also remove the matching require line from your Hyprland config.
-- If you delete this file, also remove the matching dofile line from your Hyprland config.
